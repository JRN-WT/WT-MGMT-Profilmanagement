...
def profile_for_pdf(profile: dict[str, Any], variant: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "rolle": role,
        "variante": _text(variant.get("name")),
        "kurzprofil": bio,
...
.badge {{ display: inline-block; background: {ORANGE}; color: white; font-family: 'Courier New', monospace; font-size: 7pt; letter-spacing: .04em; padding: 1.6mm 2.4mm; border-radius: 2px; }}
